import { ArrowLeft, LockKeyhole, Minus, Plus, TrendingDown, TrendingUp } from "lucide-react";
...
import IssueLifecycleStatus from "../components/issues/IssueLifecycleStatus";
import IssueRecurrenceContext from "../components/issues/IssueRecurrenceContext";
      ...
      <div className="mx-auto w-full max-w-[1040px]">
        ...
        {issueState.isLoading ? (
          ...
          <>
            ...
            <IssueRecurrenceContext issue={issue} />
            <IssueLifecycleStatus issue={issue} />
